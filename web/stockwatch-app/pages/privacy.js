    ...
    return (
        <>
            <div>
                ...
                <p>
                    Your privacy is important to us. It is Reality Stockwatch's policy to respect
                    your privacy regarding any information we may collect from you across our
                    website,
                    <a href="https://realitystockwatch.com/">https://realitystockwatch.com/</a>, and
                ...
                <p>
                    You are free to request we delete any or all of your identifying information
                    from our website or databse, with the understanding that we may then be unable
                    to provide you with some of your desired services. Such requests should be sent
                    to <a href="mailto:hello@realitystockwatch.com">hello@realitystockwatch.com</a>
                </p>
                <p>
                    ...
                    at <a href="mailto:hello@realitystockwatch.com">hello@realitystockwatch.com</a>.
                </p>
                <p>This policy is effective as of 16 February 2020.</p>
            </div>
        </>
    );
}
